...
// Script para abrir una factura en Alegra incluyendo el término
...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_con_termino.php ID_FACTURA\n";
    exit(1);
}
...
if ($factura['status'] !== 'draft') {
    ...
    // Abrir la factura incluyendo todos los campos relevantes
    echo "Intentando abrir la factura con el término de pago incluido...\n";
    
    // Datos con todos los campos posibles que podrían ser necesarios
    $datos = [
        'paymentForm' => 'CASH',
        'paymentMethod' => 'CASH',
        'term' => 'De contado'  // Incluir el término de pago que vemos en la factura
    ];
    
    echo "Datos enviados: " . json_encode($datos) . "\n";
