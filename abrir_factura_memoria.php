...
// Script para abrir una factura en Alegra usando exactamente el formato de la memoria
...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_memoria.php ID_FACTURA\n";
    exit(1);
}
...
// Abrir la factura con el formato exacto de la memoria
echo "Intentando abrir la factura con formato de la memoria...\n";

// Formato según la memoria compartida
$datos = json_encode([
    'payment' => [
        'paymentMethod' => [
            'id' => 10  // ID 10 = CASH
