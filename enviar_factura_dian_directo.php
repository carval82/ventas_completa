...
// Script para enviar facturas a la DIAN directamente usando HTTP
// Realiza solo dos pasos: abrir la factura y emitirla a la DIAN
...
if (!$idFactura) {
    ...
    echo "Uso: php enviar_factura_dian_directo.php ID_FACTURA\n";
    exit(1);
}
