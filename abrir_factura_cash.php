...
// Script simple para abrir una factura en Alegra con forma de pago CASH
...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_cash.php ID_FACTURA\n";
    exit(1);
}
...
// Abrir la factura con forma de pago CASH
echo "Intentando abrir la factura con forma de pago CASH...\n";
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.alegra.com/api/v1/invoices/{$idFactura}/open");
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "PUT");

// Datos con el formato exacto que usa AlegraService.php
$datos = json_encode([
    'paymentForm' => 'CASH',
    'paymentMethod' => 'CASH'
]);
