...
// Script simple para abrir una factura en Alegra
...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_simple.php ID_FACTURA\n";
    exit(1);
}
...
// Abrir la factura con un objeto JSON vacío
echo "Intentando abrir la factura con JSON vacío...\n";
$ch = curl_init();
