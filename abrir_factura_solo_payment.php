...
// Script para abrir una factura en Alegra usando SOLO el objeto payment
...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_solo_payment.php ID_FACTURA\n";
    exit(1);
}
...
if ($factura['status'] !== 'draft') {
    ...
    // Abrir la factura con SOLO el objeto payment
    echo "Intentando abrir la factura con SOLO el objeto payment...\n";
    
    // Formato según la memoria compartida, pero SOLO el objeto payment
    $datos = [
        'payment' => [
            'paymentMethod' => [
                'id' => 10  // ID 10 = CASH
