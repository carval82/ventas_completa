                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('regimen') is-invalid @enderror" 
                                ...
                                <option value="COMUN" {{ old('regimen') == 'COMUN' ? 'selected' : '' }}>Común</option>
                                <option value="SIMPLIFICADO" {{ old('regimen') == 'SIMPLIFICADO' ? 'selected' : '' }}>Simplificado</option>
                            </select>
                            @error('regimen')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tipo_identificacion') is-invalid @enderror" 
                                ...
                                <option value="CC" {{ old('tipo_identificacion') == 'CC' ? 'selected' : '' }}>Cédula</option>
                                <option value="CE" {{ old('tipo_identificacion') == 'CE' ? 'selected' : '' }}>Cédula Extranjería</option>
                            </select>
