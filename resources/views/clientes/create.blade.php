                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ciudad') is-invalid @enderror" 
                                   name="ciudad" value="{{ old('ciudad', 'Bogotá D.C.') }}">
                            @error('ciudad')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('departamento') is-invalid @enderror" 
                                   name="departamento" value="{{ old('departamento', 'Bogotá') }}">
                            @error('departamento')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('tipo_persona') is-invalid @enderror" name="tipo_persona">
                                <option value="PERSON_ENTITY" {{ old('tipo_persona') == 'PERSON_ENTITY' ? 'selected' : '' }}>Persona Natural</option>
                                <option value="LEGAL_ENTITY" {{ old('tipo_persona') == 'LEGAL_ENTITY' ? 'selected' : '' }}>Persona Jurídica</option>
                            </select>
                            @error('tipo_persona')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('regimen') is-invalid @enderror" name="regimen">
                                <option value="SIMPLIFIED_REGIME" {{ old('regimen') == 'SIMPLIFIED_REGIME' ? 'selected' : '' }}>Régimen Simplificado</option>
                                <option value="COMMON_REGIME" {{ old('regimen') == 'COMMON_REGIME' ? 'selected' : '' }}>Régimen Común</option>
                                <option value="SPECIAL_REGIME" {{ old('regimen') == 'SPECIAL_REGIME' ? 'selected' : '' }}>Régimen Especial</option>
                                <option value="NATIONAL_CONSUMPTION_TAX" {{ old('regimen') == 'NATIONAL_CONSUMPTION_TAX' ? 'selected' : '' }}>Impuesto Nacional al Consumo</option>
                            </select>
                            @error('regimen')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
