<?php
/**
 * Script ultra sencillo para abrir facturas en Alegra usando un JSON vacío
 * Basado en la experiencia previa exitosa del usuario
 */
...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_json_vacio.php ID_FACTURA_ALEGRA\n";
    exit(1);
}
...
echo "=================================================================\n";
echo "          APERTURA DE FACTURA - ENFOQUE JSON VACÍO              \n";
echo "=================================================================\n";
...
// Intentar abrir la factura con JSON vacío como mencionó el usuario
$urlAbrir = "https://api.alegra.com/api/v1/invoices/{$idFactura}/open";
$datos = [];  // JSON vacío

echo "\nAbriendo factura con JSON vacío...\n";
