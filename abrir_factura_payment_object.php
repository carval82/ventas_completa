...
// Script para abrir una factura en Alegra usando el formato de pago correcto según las memorias
...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_payment_object.php ID_FACTURA\n";
    exit(1);
}
...
// Abrir la factura con el formato de pago correcto según las memorias
echo "Intentando abrir la factura con el formato de pago correcto...\n";
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.alegra.com/api/v1/invoices/{$idFactura}/open");
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "PUT");

// Datos con el formato según la memoria
$datos = json_encode([
    'payment' => [
        'paymentMethod' => [
            'id' => 10  // ID 10 = CASH
...
if ($httpCode >= 200 && $httpCode < 300) {
    ...
    if ($factura['status'] === 'open') {
        ...
        // Si se abrió correctamente, intentar enviar a la DIAN
