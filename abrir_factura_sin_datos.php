...
// Script para abrir una factura en Alegra sin enviar datos adicionales
...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_sin_datos.php ID_FACTURA\n";
    exit(1);
}
...
// Intentar abrir la factura sin enviar datos adicionales
echo "Intentando abrir la factura sin enviar datos adicionales...\n";
$ch = curl_init();
