...
if (!$idFactura) {
    ...
    echo "Uso: php abrir_factura_formato_correcto.php ID_FACTURA\n";
    exit(1);
}
...
if ($factura['status'] !== 'draft') {
    ...
    // Abrir la factura con el formato correcto
    echo "Intentando abrir la factura con formato correcto...\n";
