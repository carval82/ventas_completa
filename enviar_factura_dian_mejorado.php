...
// Script mejorado para enviar facturas a la DIAN directamente usando HTTP
// Verifica si la factura existe, la abre si es necesario y la envía a la DIAN
...
if (!$idFactura) {
    ...
    echo "Uso: php enviar_factura_dian_mejorado.php ID_FACTURA\n";
    exit(1);
}
...
// Proceso principal
echo "=== Proceso de envío de factura a la DIAN ===\n";
